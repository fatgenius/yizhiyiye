...
uint8 custom_value"""
  ...
  _slot_types = ['std_msgs/Header','float64','float64','uint8','uint8','uint16','float64','scout_msgs/ScoutMotorState[4]','bool','scout_msgs/ScoutLightState','scout_msgs/ScoutLightState']
